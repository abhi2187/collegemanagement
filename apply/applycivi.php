...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT * FROM civilstudents WHERE email = ? OR phone = ?";
    ...
    $sql = "INSERT INTO civilstudents (first_name, last_name, dob, gender, email, phone, address, course, previous_school, percentage) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
