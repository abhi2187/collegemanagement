...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT * FROM mechstudents WHERE email = ? OR phone = ?";
    ...
    $sql = "INSERT INTO mechstudents (first_name, last_name, dob, gender, email, phone, address, course, previous_school, percentage) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
